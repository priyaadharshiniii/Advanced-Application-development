...
return(
  ...
  <div className="container">
    ...
    <br />
    <label htmlFor="card">Payment Type</label>
    <input
      type="text"
      minLength={16}
      maxLength={16}
    ...
    <input type="text" id="name" name="name" placeholder="------" value={bookingId} onChange={(e) => setBookingId(e.target.value)}/>
    <br />
    ...
    <div className="btn">
      ...
      <span id="submit" onClick={handlePayment}>Submit</span>
    </div>
  </div>
</div>
